  ...
  try {
    ...
    return c.json({
      ...
      rule: {
        ...
        states: JSON.parse(rule.states as string || '["*"]'),
        priority: rule.priority,
        is_active: rule.is_active === 1,
        forward_enabled: rule.forward_enabled === 1,
        forward_count: rule.forward_count || 0,
  ...
  try {
    ...
    return c.json({
      ...
      rule: {
        ...
        states: JSON.parse(updatedRule!.states as string || '["*"]'),
        priority: updatedRule!.priority,
        is_active: updatedRule!.is_active === 1,
        forward_enabled: updatedRule!.forward_enabled === 1,
        forward_count: updatedRule!.forward_count || 0,
