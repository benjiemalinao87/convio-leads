-- Schema Migration: Remove AUTOINCREMENT to Allow Custom IDs
...
-- Step 6: Create new contacts table without AUTOINCREMENT
...
-- Step 7: Copy existing contacts data (if any) to new table
INSERT INTO contacts_new SELECT * FROM contacts;

-- Step 8: Drop old contacts table
DROP TABLE contacts;

-- Step 9: Rename new table to contacts
ALTER TABLE contacts_new RENAME TO contacts;

-- Step 10: Recreate indexes for contacts table
